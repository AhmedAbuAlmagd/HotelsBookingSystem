...
namespace HotelsBookingSystem.Migrations
{
    ...
    [Migration("20250417160136_modelsUpdate1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelsBookingSystem.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3193e1f8-4350-48e4-808c-5586b5cc9024",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHtF44eveUrH6zIf+ZBYGtYhZ415eK380wMk6IMSfN4qGw7Klyu0hwLGSyPt/BsZVA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0c80b3af-9bcc-4492-99ec-458ad6b9782e",
            ...
            modelBuilder.Entity("HotelsBookingSystem.Models.Booking", b =>
                {
                    ...
                    b.HasOne("HotelsBookingSystem.Models.Room", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("HotelsBookingSystem.Models.Room", b =>
                {
                    b.HasOne("HotelsBookingSystem.Models.Hotel", null)
                        .WithMany("Rooms")
                        .HasForeignKey("HotelId");
                });
