...
namespace HotelsBookingSystem.Migrations
{
    ...
    [Migration("20250420192558_Setupandsnapshoot")]
    partial class Setupandsnapshoot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CartItemService", b =>
                {
                    ...
                    b.HasKey("CartItemsId", "ServicesId");

                    b.HasIndex("ServicesId");

                    b.ToTable("CartItemService");
                });
            ...
            modelBuilder.Entity("CartItemService", b =>
                {
                    b.HasOne("HotelsBookingSystem.Models.CartItem", null)
                        .WithMany()
                        .HasForeignKey("CartItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelsBookingSystem.Models.Service", null)
                        .WithMany()
